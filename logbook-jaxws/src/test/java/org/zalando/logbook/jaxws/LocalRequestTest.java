...
public class LocalRequestTest {
    ...
    @Test
    void given_soap_11_message_should_return_information_of_request()
        ...
        lenient().when(context.get(BindingProvider.ENDPOINT_ADDRESS_PROPERTY))
                .thenReturn("http://localhost:8080/soap/operation");
    ...
    @Test
    void given_soap_12_message_should_return_protocol()
            throws UnsupportedEncodingException, IOException, SOAPException {
        // -- mocks
