...
public final class DefaultHttpLogFormatterTest {
    ...
    public void shouldLogRequest() throws IOException {
        ...
        assertThat(http, equalTo("Request: c9408eaa-677d-11e5-9457-10ddb1ee7671\n" +
    ...
    public void shouldLogRequestWithoutQueryParameters() throws IOException {
        ...
        assertThat(http, equalTo("Request: 2bd05240-6827-11e5-bbee-10ddb1ee7671\n" +
                "GET /test HTTP/1.1\n" +
                "Accept: application/json\n" +
                "Content-Type: text/plain\n" +
                "\n" +
    ...
    public void shouldLogRequestWithoutBody() throws IOException {
        ...
        assertThat(http, equalTo("Request: 0eae9f6c-6824-11e5-8b0a-10ddb1ee7671\n" +
                "GET /test HTTP/1.1\n" +
                "Accept: application/json"));
    }
    ...
    public void shouldLogResponse() throws IOException {
        ...
        assertThat(http, equalTo("Response: 2d51bc02-677e-11e5-8b9b-10ddb1ee7671\n" +
                "HTTP/1.1 200\n" +
    ...
    public void shouldLogResponseWithoutBody() throws IOException {
        ...
        assertThat(http, equalTo("Response: 3881ae92-6824-11e5-921b-10ddb1ee7671\n" +
                "HTTP/1.1 200\n" +
                "Content-Type: application/json"));
    }
