...
public final class Filters {
    ...
    public static QueryFilter obfuscate(final String name, final String replacement) {
    ...
    public static HeaderFilter obfuscate(final Predicate<String> keyPredicate, final String replacement) {
        return (key, value) -> keyPredicate.test(key) ? replacement : value;
    }

    public static HeaderFilter obfuscate(final BiPredicate<String, String> predicate, final String replacement) {
    ...
    static Map<String, List<String>> filterHeaders(final Map<String, List<String>> map,
            final BinaryOperator<String> filter) {
        ...
        for (final Map.Entry<String, List<String>> e : map.entrySet()) {
            ...
            builder.put(k, e.getValue().stream().map(x -> filter.apply(k, x)).collect(toList()));
        }
