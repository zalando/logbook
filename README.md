...
##### Key-Value
*Key-Value* is an alternative formatting style, provided byt the `KeyValueHttpLogFormatter` which will render
...
| `logbook.format.style`         | [Formatting style](#formatting) (`http`, `json`, `curl` or `kv`)| `json`                        |
